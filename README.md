...
```bash
bash <(curl -Ss https://raw.githubusercontent.com/RatNodes-Hosting-LLC/Pelinstaller/Production/install.sh || wget -O - https://raw.githubusercontent.com/RatNodes-Hosting-LLC/Pelinstaller/Production/install.sh) auto
```
